...
\begin{document}
    ...
    \section{What is Computer?}
        ...
        \subsection{Countess, weaving patterns and count machines}
            ...
            relies on a simple mechanical action of those cards. While continuously moving, those cards would move controlling rods of the loom, therefore affection knot being weaved. 
            ...
            \begin{wrapfigure}{l}{0.5\textwidth}
                \centering
                \includegraphics[scale=0.8]{images/devices/device_loom_punch_card.jpg}
                \caption{Sequence of punch card}
            \end{wrapfigure}

            This machine would \emph{drastically} impact effeciency, since it was no longer required to be of high skill to weave complicate patterns.
