...
\begin{document}
    ...
    \section{What is Computer?}
        ...
        \subsection{Standartisation, Specification, Simplification}
            ...
            byte will represent a fractional part. For example:

            \begin{longtable}{|c|c|c|}
                \hline
                $base_{10}$ number & integer part & decimal part \\\hline
                1.0 & 00000001 & 00000000 \\\hline
                25.0 & 00011001 & 00000000 \\\hline
            \end{longtable}
