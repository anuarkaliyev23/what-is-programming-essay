        ...
        \subsection{You can't manage what you can't measure}
            ...
            \begin{center}
                \begin{tabular}{|c|c|c|}
                    ...
                    \ldots & \ldots & \ldots \\
                    \hline
                    $x$ & $2^x$ & \{ $x$ times 0, \ldots, $x$ times 1\} \\
                    \hline
                \end{tabular}
                \label{tab:Bits} Maximum options, that can be represented by $x$ number of bits
            \end{center}
            ...
            everything in a $base_{10}$. This simply means, that we have \emph{10 digits} that construct \emph{all of our numbers}
            \footnote{There are examples of cultures, that used different number as their base. However $base_{10}$ is the ubiquitous one nowadays}. 
            ...
            \begin{center}
                \begin{longtable}{|c|c|c|c|}
                    ...
                    \hline
                \end{longtable}
                \label{tab:Bases} Examples of different bases representing the same number
            \end{center}
            ...
            conclude the total number of bits this information will occupy, I can use something called \emph{Hartley function} to find out. It can be represented
            \footnote{This form is somewhat simplified for the sake of clarity. Full Hartley Formula can be denoted as: $H_0(A) := log_b|A|$}
            as: $2^x \geq N$ with $N$ -- representing our total outcomes number, 2 -- representing possible options for one bit and \emph{$x$ -- number of bits we need to store it}.
            ...
            \begin{center}
                \begin{longtable}{|c|c|}
                    ...
                    \hline
                \end{longtable}
                \label{tab:T-Shirts} T-Shirts with assigned code represented as bit sequence
            ...
            information, they would send me `0010' representing it's color in this particular context.
