    ...
    \section{What is Computer?}
        ...
        \subsection{Countess, weaving patterns and count machines}
            ...
            \begin{CJK}{UTF8}{}
                ...
                cultures\footnote{\href{https://en.wikipedia.org/wiki/Abacus}{https://en.wikipedia.org/wiki/Abacus}}: 算盤\footnote{`suanpan', China}, 
                そろばん\footnote{`soroban', Japan. Can be represented as `算盤' also},
                주판\footnote{`jupan', Korea. Could also be called supan (수판), jusan (주산)}, nepohualtzintzin\footnote{Aztec culture}, счёты\footnote{`schoty', Russia}
            \end{CJK}
            \newpage
